    ...
    public List<BookingOutDto> getAllOfUserByState(Long userId, BookingState state) {
        ...
        switch (state) {
            ...
            case REJECTED:
                ...
                break;
            case CANCELLED:
                bookings = bookingRepository.findByBookerIdAndStatusOrderByStartDesc(userId, BookingStatus.CANCELLED);
                break;
            default: // ALL
    ...
    public List<BookingOutDto> getAllOfOwnerByState(Long userId, BookingState state) {
        ...
        switch (state) {
            ...
            case REJECTED:
                ...
                break;
            case CANCELLED:
                bookings = bookingRepository.findByItemOwnerIdAndStatusOrderByStartDesc(userId, BookingStatus.CANCELLED);
                break;
            default:
